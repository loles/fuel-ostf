...
Revision ID: 17798ef53046
Revises: None
Create Date: 2013-09-26 17:14:06.084511

"""

# revision identifiers, used by Alembic.
revision = '17798ef53046'
down_revision = None
...
### commands auto generated by Alembic - please adjust! ###
    ...
    sa.Column('additional_arguments', sa.ListField(), nullable=True),
    sa.Column('cleanup_path', sa.String(length=128), nullable=True),
    sa.Column('meta', sa.JsonField(), nullable=True),
    sa.Column('deployment_tags', postgresql.ARRAY(String(length=64)), nullable=True),
    ...
    sa.ForeignKeyConstraint(['test_set_id', 'cluster_id'], ['test_sets.id', 'test_sets.cluster_id'], ),
    ...
    sa.Column('status', sa.Enum('wait_running', 'running', 'failure', 'success', 'error', 'stopped', name='test_states'), nullable=True),
